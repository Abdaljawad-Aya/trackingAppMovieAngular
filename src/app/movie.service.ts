...
export class MovieService {
  ...
  // to use http client we declared as independency in the constructor
  // then use http get request to fetch data
  constructor(private http:HttpClient) { }

  getMovies(): Observable<Movie[]> {
    // const movies = of(MOVIE);
    // return movies;
    // this <Movie[]> is called type of Observable an array of movies basically it cast the 
  ...
  deleteMovie(movie:Movie): Observable<Movie> {
    // this a placeholder for the site name and which ever the is that will be deleted
